CreateThread(function()
    ...
    local Daily_NPC = CreatePed(4, Config.Daily_NPC.ped, Config.Daily_NPC.coords.x, Config.Daily_NPC.coords.y, Config.Daily_NPC.coords.z - 1.0, Config.Daily_NPC.coords.w, false, true)
